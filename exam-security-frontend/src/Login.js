    ...
    switch(role) {
      ...
      case 'admin':
        return { 
          ...
          placeholder: 'isim@maltepe.edu.tr', 
          icon: <FaUniversity />, 
          type: 'email' 
        };
      case 'proctor':
        return { 
          label: 'Gözetmen Kullanıcı Adı', 
          placeholder: 'Örn: gozetmen_01', 
          icon: <FaChalkboardTeacher />, 
          type: 'text' 
        };
      default:
        return { label: 'Kullanıcı Adı', placeholder: '', icon: <FaUser />, type: 'text' };
    }
  };
